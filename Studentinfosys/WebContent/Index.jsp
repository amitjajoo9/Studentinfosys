...
<body >
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img class="logo-custom" src="assets/img/logo.jpg" alt="" width="100px" height="700%" /></a>
            </div>
            <div class="navbar-collapse collapse move-me">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <!--  <li><a href="#features-sec">FEATURES</a></li>-->
                     ...
                     <li><a href="#course-sec">INSTITUTES</a></li>
                     <li><a href="#course-sec">PLACEMENT</a></li>
                    <li><a href="#course-sec">GALLERY</a></li> 
 ...
 <div class="container">
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> WELCOME TO THE INFOTECH ACADEMY <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
    ...
    <div class="container set-pad">
           ...
           <div class="row" >
                 ...
                 <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                   ...
                   <h3 >Mr.Sajal chakraborty </h3>
                 <hr />
                         <h4>COMPUTER SCIENCE <br /> Department</h4>
                   <p>
                 ...
                 <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                     <div class="faculty-div">
                     <img src="assets/img/faculty/4.jpg"  class="img-rounded"  width="230px"  height="150px"/>
                   <h3 >Ms.Anjali Pandey</h3>
                 <hr />
                        <h4>COMPUTER SCIENCE<br /> Department</h4>
                   <p >  
                   </p>
               ...
               <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                   ...
                   <h3 >Mr.Amit Jaju</h3>
                 <hr />
                         <h4>Web designing<br /> Department</h4>
                   <p >
                   </p>
                </div>
                 </div>
    ...
    <!-- FACULTY SECTION END-->
      <div id="course-sec" class="container set-pad">
           ...
           <div class="col-lg-6 col-md-6 col-sm-6 " data-scroll-reveal="enter from the bottom after 0.4s" >
               ...
               "WebContent/examupdate.jsp"             <div class="panel-heading" >
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse1" class="collapsed">
                                  <strong>   10+</strong> BASIC COURSES 
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse2" class="collapsed">
                                      <strong>   10+</strong> COMPUTER COURSES 
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse3" class="collapsed">
                                        <strong>   5+</strong> POST-GRADUATION COURSES 
                                    </a>
                                </h4>
                            </div>
 ...
 <div class="container set-pad">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
                    <div ">
                        <h4>234/80 MIG colony ,near LIG square,indore,</h4>
                        <h4>INDORE (m.p.)</h4>
                        <h4><strong>Call:</strong>  + 91-0731-6023469 / 70 / 71 </h4>
                        <h4><strong>Email: </strong>infotech@gmail.com</h4>
                    </div>
