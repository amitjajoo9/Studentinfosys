           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="coursedetail.jsp">Add Course</a>
                                    </li>
                      ...
                      <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="examrecord.jsp">Add Exam</a>
                                    </li>
                    ...
                    <a href="#"><i class="fa fa-sitemap fa-3x"></i> Faculty<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="facultydetail.jsp">Add Faculty</a>
                                    </li>
