...
public class RegistrationServlet extends HttpServlet {private static final long serialVersionUID = 1L;
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
   ...
   Class.forName("com.mysql.jdbc.Driver");
	  ...
	  String query="insert into studregistration(Firstname,Lastname,Fathername,Mothername,DOB,Gender,Course,Email,Mobileno,Alternatemobile,Address,City,State,Image,Passyear) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
